...
{
    if (id == 0)
        last_id0_msg = "<" + String(id) + "," + String(rssi) + "," + String(battery) + ">";
    if (id == 1)
        last_id1_msg = "<" + String(id) + "," + String(rssi) + "," + String(battery) + ">";
    if (id == 2)
        last_id2_msg = "<" + String(id) + "," + String(rssi) + "," + String(battery) + ">";
    if (id == 3)
        last_id3_msg = "<" + String(id) + "," + String(rssi) + "," + String(battery) + ">";
    if (id == 4)
        last_id4_msg = "<" + String(id) + "," + String(rssi) + "," + String(battery) + ">";
    if (id == 5)
        last_id5_msg = "<" + String(id) + "," + String(rssi) + "," + String(battery) + ">";
}
