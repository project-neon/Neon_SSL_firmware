// Marco de controle dos motores BLDC das rodas do robô.
// Placa: Blue Pill (STM32F103C8) via SimpleFOC.
// Recebe comandos de velocidade pela Serial no formato:
...
void loop() {
  ...
  if (second_mark - first_mark > 300) {
    ...
    // driver2.setPhaseState(_HIGH_IMPEDANCE , _HIGH_IMPEDANCE,
    // _HIGH_IMPEDANCE);
    m1 = 0.00;
    m2 = 0.00;
  }  // else{
